...
get "/" do 
	...
	usercode2  = params["usercode1"].to_i
	testing = caesar_cipher(userword2.to_s,usercode2)
  erb :index, :locals => {:userword => userword2, :usercode => usercode2, :testing => testing}
end
